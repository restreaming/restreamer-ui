						...
						<ListItemText
							primary={
								<Typography variant="body3">
									<Duration
										seconds={$resources.uptime_seconds}
									/>
								</Typography>
							}
							secondary={``}
						...
						<ListItemText
							...
							secondary={
								<Typography variant="body2">
									<Number
										value={
											system.mem_used_bytes / 1024 / 1024
										}
									/>{' '}
									/{' '}
									<Number
										value={
											system.mem_total_bytes / 1024 / 1024
										}
									/>{' '}
									<Trans>MB</Trans>
								</Typography>
							...
							<ListItemText
								...
								secondary={
									<Typography variant="body2">
										...
										<Number value={core.session_limit} />{' '}
										<Trans>Viewer</Trans>
									</Typography>
								}
							/>
						...
						{core.net_used >= 0 ? (
							<ListItemText
								...
								secondary={
									<Typography variant="body2">
										<Number
											value={core.net_used_kbit / 1024}
										/>{' '}
										/{' '}
										<Number
											value={core.net_limit_kbit / 1024}
										/>{' '}
										Mbit/s
									</Typography>
								}

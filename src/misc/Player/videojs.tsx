    ...
    >
      ...
      >
        <Player.Provider>
          <Player.Container
            className={
              type === "videojs-internal" ? "media-internal" : "media-public"
            }
          >
            {controls ? (
            ...
            {logo && logo.image && (
              <div
                style={{
                  ...
                  zIndex: 10,
                  margin: "15px",
                  top: logo.position.includes("top") ? 0 : "auto",
                  bottom: logo.position.includes("bottom") ? "50px" : "auto",
                  left: logo.position.includes("left") ? 0 : "auto",
                  right: logo.position.includes("right") ? 0 : "auto",

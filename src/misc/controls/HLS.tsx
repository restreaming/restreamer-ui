  ...
  return (
    <Grid container spacing={2}>
      ...
      <Grid size={12}>
        ...
        <Typography variant="caption">
          <Trans>
            Where to store the HLS playlist and segments. In-Memory is
            recommended.
          </Trans>
        </Typography>
      </Grid>
      <Grid size={12}>
        ...
        <Typography variant="caption">
          <Trans>
            Playlist version (M3U8). Version 3 has the best browser/client
            compatibility.
          </Trans>
        </Typography>
      </Grid>
      ...
      >
        ...
        <Typography variant="caption">
          <Trans>
            Segment will be cut on the following keyframe after this time has
            passed. 2 is recommended.
          </Trans>
        </Typography>
      </Grid>
      <Grid
      ...
      >
        ...
        <Typography variant="caption">
          <Trans>
            The maximum number of playlist segments. 0 will contain all the
            segments. 6 is recommended.
          </Trans>
        </Typography>
      </Grid>
      <Grid size={12}>

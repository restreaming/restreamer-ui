		...
		<Grid container spacing={2}>
			...
			*/}
			<Grid item xs={12}>
				...
				<Typography variant="caption">
					<Trans>
						Where to store the HLS playlist and segments. In-Memory
						is recommended.
					</Trans>
				</Typography>
			</Grid>
			<Grid item xs={12}>
				...
				>
					...
					<MenuItem value={6}>
						<Trans>
							6 (+ guaranteed to start with a Key frame)
						</Trans>
					</MenuItem>
					<MenuItem value={7}>
				...
				<Typography variant="caption">
					<Trans>
						Playlist version (M3U8). Version 3 has the best
			...
			<Grid item xs={12} md={6}>
				...
				<Typography variant="caption">
					<Trans>
						Segment will be cut on the following keyframe after this
						time has passed. 2 is recommended.
					</Trans>
				</Typography>
			</Grid>
			<Grid item xs={12} md={6}>
				...
				<Typography variant="caption">
					<Trans>
						The maximum number of playlist segments. 0 will contain
						all the segments. 6 is recommended.
					</Trans>
				</Typography>
			</Grid>
			<Grid item xs={12}>
				<Checkbox
					label={
						<Trans>
							Master playlist (increases browser/client
							compatibility)
						</Trans>
					}

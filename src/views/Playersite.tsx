							...
							<Grid container spacing={2}>
								...
								<Grid item xs={12}>
									<Typography variant="body1">
										<Trans>
											...
											Restreamer offers a complete
											landingpage, which you can use to
											present your live stream easily and
											quickly.
										</Trans>
									</Typography>
								</Grid>
								...
								<Grid item xs={12}>
									<MultiSelect
										...
										type="select"
										label={
											<Trans>Additional channels</Trans>
										}
									...
									<Typography variant="caption">
										<Trans>
											Additional channels to display on
											the playersite.
										</Trans>
									</Typography>
								</Grid>
								...
								<Grid item xs={12}>
									...
									<Typography variant="caption">
										<Trans>
											Shows a reference to the project.
										</Trans>
									</Typography>
								</Grid>
							</Grid>
						...
						<TabPanel value={$tab} index="template">
							<Grid container spacing={2}>
								...
								<Grid item xs={12} md={9}>
									...
									<Typography variant="caption">
										<Trans>
											Template to be used for creating the
											publication website. The delete
											button removes the selection from
											the system.
										</Trans>
									</Typography>
								</Grid>
								...
								<Grid item xs={12} md={9}>
									...
									<Typography variant="caption">
										<Trans>
											Name for the template. If the name
								...
								<Grid item xs={12} md={3}>
									<UploadButton
										...
										color="primary"
										disabled={
											$settings.templatename.length === 0
										}
						...
						<TabPanel value={$tab} index="design">
							<Grid container spacing={2}>
								...
								<Grid item xs={12} md={8}>
									...
									<Typography variant="caption">
										<Trans>
											Address for the background image.
										</Trans>
									</Typography>
								</Grid>
						...
						<TabPanel value={$tab} index="code_injection">
							<Grid container spacing={2}>
								...
								<Grid item xs={12}>
									<Typography variant="body1">
										<Trans>
											...
											the publication site. You can find
											some examples on the help page.
										</Trans>
									</Typography>
								</Grid>
								<Grid item xs={12}>
								...
								<Grid item xs={12}>
									...
									<Typography variant="caption">
										<Trans>
											Expands the area above the channel
											list (live chat).
										</Trans>
									</Typography>
								</Grid>
								...
								<Grid item xs={12}>
									...
									<Typography variant="caption">
										<Trans>
											Expands the area under the channel
											description (comment boxes).
										</Trans>
									</Typography>
								</Grid>
								<Grid item xs={12}>

  ...
  const handleUploadError = (title: Any) => (err: Any) => {
    const message = ((...args: Any[]) => {
      ...
      switch (err.type) {
        ...
        case "read":
          return <Trans>There was an error during upload: {err.message}</Trans>;
        default:
  ...
  const handleDone = async (...args: Any[]) => {
    ...
    if (res === false) {
      notify.Dispatch(
        "error",
        "save:playersite",
        i18n._(t`Failed to store player size setting.`),
      );
      setSaving(false);
      return;
    }
    ...
    if (resUpdate === false) {
      notify.Dispatch(
        "error",
        "save:playersite",
        i18n._(t`Failed to create publication website files.`),
      );
      setSaving(false);
      return;
    }
    ...
    notify.Dispatch(
      "success",
      "save:playersite",
      i18n._(t`Publication website settings saved`),
    );
  };
        ...
        <Grid container spacing={2}>
          <TabsVerticalGrid>
            ...
            >
              ...
              <Tab
                className="tab"
                label={<Trans>Code injection</Trans>}
              ...
              <Grid container spacing={2}>
                ...
                <Grid size={12}>
                  <Typography variant="body1">
                    <Trans>
                      In addition to the player, the Restreamer offers a
                      complete landingpage, which you can use to present your
                      live stream easily and quickly.
                    </Trans>
                  </Typography>
                </Grid>
                <Grid size={12}>
                ...
                <Grid size={12}>
                  ...
                  <Typography variant="caption">
                    <Trans>
                      Additional channels to display on the playersite.
                    </Trans>
                  </Typography>
                </Grid>
                <Grid size={12}>
            ...
            <TabPanel value={$tab} index="template">
              <Grid container spacing={2}>
                ...
                >
                  ...
                  <Typography variant="caption">
                    <Trans>
                      Template to be used for creating the publication website.
                      The delete button removes the selection from the system.
                    </Trans>
                  </Typography>
                </Grid>
                <Grid
                ...
                >
                  ...
                  <Typography variant="caption">
                    <Trans>
                      Name for the template. If the name already exists, it will
                      be overwritten.
                    </Trans>
                  </Typography>
                </Grid>
            ...
            <TabPanel value={$tab} index="design">
              <Grid container spacing={2}>
                ...
                <Grid size={12}>
                  <Typography variant="body1">
                    <Trans>
                      Adjust publication site colors and background as you like.
                    </Trans>
                  </Typography>
                </Grid>
                <Grid size={12}>
            ...
            <TabPanel value={$tab} index="code_injection">
              <Grid container spacing={2}>
                ...
                <Grid size={12}>
                  <Typography variant="body1">
                    <Trans>
                      Add external widgets and styles to the publication site.
                      You can find some examples on the help page.
                    </Trans>
                  </Typography>
                </Grid>
                <Grid size={12}>
                ...
                <Grid size={12}>
                  ...
                  <Typography variant="caption">
                    <Trans>
                      Expands the area above the channel list (live chat).
                    </Trans>
                  </Typography>
                </Grid>
                <Grid size={12}>
                ...
                <Grid size={12}>
                  ...
                  <Typography variant="caption">
                    <Trans>
                      Expands the area under the channel description (comment
                      boxes).
                    </Trans>
                  </Typography>
                </Grid>

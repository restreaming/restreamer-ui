  ...
  auths = auths
    .map((a) => {
      ...
      if (params[0] === "localjwt") {
        ...
        if (
          auth0.domain.length === 0 ||
          auth0.audience.length === 0 ||
          auth0.client_id.length === 0
        ) {
          return null;
        }
          ...
          <Grid sx={{ textAlign: "center" }} size={12}>
            {$auths.length > 1 && (
              <ToggleButtonGroup
                value={$loginTarget}
                exclusive
                onChange={handleLoginTargetChange}
              >
                  ...
                  <Typography>
                    <Trans>
                      ...
                      <Link
                        color="secondary"
                        target="_blank"
                        href="https://github.com/datarhei"
                      >
                        details
                      </Link>
                      .
                ...
                {$canUseAuth0 === false ? (
                  <React.Fragment>
                    <Grid sx={{ textAlign: "center" }} size={12}>
                      <Typography>
                        <Trans>
                          Auth0 is currently not available because this
                          interface is loaded from an insecure origin.
                        </Trans>
                      </Typography>
                    </Grid>
                  </React.Fragment>
                  ...
                  <React.Fragment>
                    {$isAuthenticated === false ? (
                      <React.Fragment>
                        <Grid size={12}>
                          <Select
                            label={<Trans>Auth0 Tenant</Trans>}
                            value={$auth0}

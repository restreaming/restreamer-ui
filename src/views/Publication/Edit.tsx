...
export default function Edit(props) {
	...
	const handleServiceDelete = async () => {
		...
		notify.Dispatch(
			...
			'delete:egress:' + _service,
			i18n._(
				t`The publication service "${$settings.name}" has been deleted`,
			),
		);
	...
	return (
		<Root>
								...
								<Grid size={12}>
									<Typography variant="subheading">
										<Trans>
											...
											disabled if necessary. Each encoding
											requires additional CPU/GPU
											resources.
										</Trans>
									</Typography>
								</Grid>
			...
			>
				<Typography>
					<Trans>
						Deleting a publication service cannot be reversed. The

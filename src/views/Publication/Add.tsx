	...
	const handleServiceDone = async () => {
		...
		if (err !== null) {
			...
			notify.Dispatch(
				...
				'save:egress:' + $service,
				i18n._(
					t`Failed to create publication service (${err.message})`,
				),
			);
			return;
		}
										...
										{$settings.profiles[0].video.encoder
											...
											<Grid size={12}>
												<FilterSelect
													...
													onChange={handleProcessingFilter(
														'video',
													)}
												/>
											</Grid>

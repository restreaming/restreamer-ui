...
const description = (
	<Trans>
		Transmit the main source to the Akamai (MSL) Media Services Live. More
		details about the MSL Encoder settings can be found on{' '}
		<Link
			color="secondary"
			target="_blank"
...
function Service(props) {
	...
	const createOutput = (settings) => {
		...
		for (const key in settings.address_extensions) {
			...
			address_extensions.push(
				key + '=' + settings.address_extensions[key],
			);
		}

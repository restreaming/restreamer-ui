...
const description = (
  <Trans>
    Transmit the main source to an WOWZA Server. More details about the settings
    can be found{" "}
    <Link
      color="secondary"
      target="_blank"
      href="https://www.wowza.com/docs/how-to-restream-using-ffmpeg-with-wowza-streaming-engine"
    >
      here
    </Link>
    .
      ...
      {settings.protocol === "rtsp://" && (
        <Grid size={12}>
          <Checkbox
            ...
            onChange={handleChange("rtsp_over_udp")}
          />
        </Grid>
      )}
      <Grid

...
const stream_key_link =
	'https://restream.io/settings/streaming-setup?from=datarhei/restreamer';
const description = (
	<Trans>
		Transmit the main source to the Restream RTMP Service. More details
		...
		<Grid container spacing={2}>
			<Grid item xs={12}>
				...
				>
					...
					<MenuItem value="frankfurt">
						EU-Central - Frankfurt, DE
					</MenuItem>
					<MenuItem value="falkenstein">
						EU-East - Falkenstein, DE
					</MenuItem>
					...
					<MenuItem value="miami.restream.io/live">
						US-East - Miami, FL
					</MenuItem>
					<MenuItem value="chicago">US-East - Chicago, IL</MenuItem>
					<MenuItem value="toronto">
						NA-East - Toronto, Canada
					</MenuItem>
					<MenuItem value="saopaulo">
						SA - Saint Paul, Brazil
					</MenuItem>

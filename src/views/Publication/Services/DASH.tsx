...
const description = (
	<Trans>
		Transmit the main source as MPEG-DASH to an HTTP/S Server. More details
		about the settings can be found{' '}
		<Link
			color="secondary"
			target="_blank"
			href="http://ffmpeg.org/ffmpeg-all.html#dash"
		>
			here
		</Link>
		.
						...
						<Grid container spacing={2}>
							...
							<Grid size={12}>
								<Checkbox
									...
									onChange={handleChange('http_persistent')}
								/>
								<Checkbox
									label="streaming"
									checked={settings.options.streaming}
									onChange={handleChange('streaming')}
								/>
								<Checkbox
									label="ignore_io_errors"
									checked={settings.options.ignore_io_errors}
									onChange={handleChange('ignore_io_errors')}
								/>
								<Checkbox
									label="lhls"
									checked={settings.options.lhls}
									onChange={handleChange('lhls')}
								/>
								<Checkbox
									label="ldash"
									checked={settings.options.ldash}
							...
							<Grid size={12}>
								{!settings.options.streaming && (
									<Checkbox
										label="single_file"
										checked={settings.options.single_file}
										onChange={handleChange('single_file')}
									/>
								)}
								<Checkbox
									label="remove_at_exit"
									checked={settings.options.remove_at_exit}
									onChange={handleChange('remove_at_exit')}
								/>
								<Checkbox
									label="use_template"
									checked={settings.options.use_template}
									onChange={handleChange('use_template')}
								/>
								<Checkbox
									label="use_timeline"
									checked={settings.options.use_timeline}
									onChange={handleChange('use_timeline')}
								/>
								<Checkbox
									label="index_correction"
									checked={settings.options.index_correction}
									onChange={handleChange('index_correction')}
								/>
								<Checkbox
									label="hls_playlist"
									checked={settings.options.hls_playlist}
							...
							{settings.options.single_file && (
								...
								>
									<TextField
										...
										value={
											settings.options.single_file_name
										}
							...
							<Grid size={12}>
								<Typography>
									...
									<Link
										color="secondary"
										target="_blank"
										href="https://ffmpeg.org/ffmpeg-all.html#dash"
									>

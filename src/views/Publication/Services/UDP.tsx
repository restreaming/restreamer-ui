...
const description = (
	<Trans>
		Transmit the main source to an UDP Server. More details about the
		settings can be found{' '}
		<Link
			color="secondary"
			target="_blank"
			href="https://ffmpeg.org/ffmpeg-all.html#udp"
		>
			here
		</Link>
		.
						...
						<Grid container spacing={2}>
							...
							<Grid item xs={12}>
								<Checkbox
									...
									onChange={handleChange('overrun_nonfatal')}
								/>
								<Checkbox
									label="broadcast"
									checked={settings.params.broadcast}

...
const description = (
	<Trans>
		Transmit the main source to an RTSP Server. More details about the
		settings can be found{' '}
		<Link
			color="secondary"
			target="_blank"
			href="https://ffmpeg.org/ffmpeg-all.html#rtsp"
		>
			here
		</Link>
		.
						...
						<Grid container spacing={2}>
							...
							<Grid size={12}>
								<Select
									...
									value={settings.options.rtsp_transport}
									onChange={handleChange('rtsp_transport')}
								>
									<MenuItem value="">default</MenuItem>
									<MenuItem value="udp">udp</MenuItem>
									<MenuItem value="tcp">tcp</MenuItem>
									<MenuItem value="udp_multicast">
										udp_multicast
									</MenuItem>
							...
							<Grid size={12}>
								<Select
									type="select"
									label="rtsp_flags"
									value={settings.options.rtsp_flags}
									onChange={handleChange('rtsp_flags')}
								>
									<MenuItem value="">default</MenuItem>
									<MenuItem value="prefer_tcp">
										prefer_tcp
									</MenuItem>
								</Select>
							</Grid>

...
const description = (
  <Trans>
    Transmit the audio channel of the main source to an Icecast Server. More
    details about the settings can be found{" "}
    <Link
      color="secondary"
      target="_blank"
      href="https://ffmpeg.org/ffmpeg-all.html#Icecast"
    >
      here
    </Link>
    .
              ...
              <Grid size={12}>
                <Typography>
                  ...
                  <Link
                    color="secondary"
                    target="_blank"
                    href="http://ffmpeg.org/ffmpeg-all.html#Icecast"
                  >

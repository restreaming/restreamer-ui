...
const description = (
  <Trans>
    Transmit the main source to an livespotting.com Ressource. More details
    about the settings can be found{" "}
    <Link
      color="secondary"
      target="_blank"
      href="https://livespotting.com/products-vpu.html"
    >
      here
    </Link>
    .
    ...
    <Grid container spacing={2}>
      ...
      >
        <TextField
          variant="outlined"
          fullWidth
          label={<Trans>VPU ID</Trans>}
          value={settings.vpu_id}

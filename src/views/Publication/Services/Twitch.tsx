        ...
        <Grid container spacing={2}>
            <Grid size={12}>
				...
				>
					...
					<MenuItem value="blr01.contribute.live-video.net">
						Asia - India, Bangalore
					</MenuItem>
					<MenuItem value="maa01.contribute.live-video.net">
						Asia - India, Chennai
					</MenuItem>
					<MenuItem value="hyd01.contribute.live-video.net">
						Asia - India, Hyderabad
					</MenuItem>
					<MenuItem value="bom01.contribute.live-video.net">
						Asia - India, Mumbai
					</MenuItem>
					<MenuItem value="del01.contribute.live-video.net">
						Asia - India, New Delhi
					</MenuItem>
					<MenuItem value="jkt01.contribute.live-video.net">
						Asia - Indonesia, Cikarang Barat
					</MenuItem>
					<MenuItem value="jkt02.contribute.live-video.net">
						Asia - Indonesia, Jakarta
					</MenuItem>
					<MenuItem value="osa01.contribute.live-video.net">
						Asia - Japan, Osaka
					</MenuItem>
					<MenuItem value="live-tyo">Asia - Japan, Tokyo</MenuItem>
					<MenuItem value="mnl01.contribute.live-video.net">
						Asia - Philippines, Manila
					</MenuItem>
					<MenuItem value="live-sin">Asia - Singapore</MenuItem>
					<MenuItem value="live-sel">
						Asia - South Korea, Seoul
					</MenuItem>
					<MenuItem value="live-tpe">Asia - Taiwan, Taipei</MenuItem>
					<MenuItem value="bkk02.contribute.live-video.net">
						Asia - Thailand, Bangkok
					</MenuItem>
					<MenuItem value="live-vie">
						Europe - Austria, Vienna
					</MenuItem>
					<MenuItem value="live-prg">
						Europe - Czech Republic, Prague
					</MenuItem>
					<MenuItem value="live-cph">
						Europe - Denmark, Copenhagen
					</MenuItem>
					<MenuItem value="live-hel">
						Europe - Finland, Helsinki
					</MenuItem>
					<MenuItem value="live-mrs">
						Europe - France, Marseille
					</MenuItem>
					<MenuItem value="live-cdg">Europe - France, Paris</MenuItem>
					<MenuItem value="live-ber">
						Europe - Germany, Berlin
					</MenuItem>
					<MenuItem value="dus01.contribute.live-video.net">
						Europe - Germany, Dusseldorf
					</MenuItem>
					<MenuItem value="live-fra">
						Europe - Germany, Frankfurt
					</MenuItem>
					<MenuItem value="muc01.contribute.live-video.net">
						Europe - Germany, Munich
					</MenuItem>
					<MenuItem value="live-mil">Europe - Italy, Milan</MenuItem>
					<MenuItem value="live-ams">
						Europe - Netherlands, Amsterdam
					</MenuItem>
					<MenuItem value="live-osl">Europe - Norway, Oslo</MenuItem>
					<MenuItem value="live-waw">
						Europe - Poland, Warsaw
					</MenuItem>
					<MenuItem value="live-lis">
						Europe - Portugal, Lisbon
					</MenuItem>
					<MenuItem value="live-mad">Europe - Spain, Madrid</MenuItem>
					<MenuItem value="live-arn">
					...
					<MenuItem value="live-syd">
						Oceania - Australia, Sydney
					</MenuItem>
					<MenuItem value="live-scl">
						South America - chile, Santiago
					</MenuItem>
					<MenuItem value="for01.contribute.live-video.net">
						South America - Brazil, Fortaleza
					</MenuItem>
					<MenuItem value="live-rio">
						South America - Brazil, Rio de Janeiro
					</MenuItem>
					<MenuItem value="live-sao">
						South America - Brazil, Sao Paulo
					</MenuItem>
					<MenuItem value="live-eze">
						South America - Buenos Aires, Argentina
					</MenuItem>
					<MenuItem value="bog01.contribute.live-video.net">
						South America - Colombia, Bogota
					</MenuItem>
					<MenuItem value="live-mde">
						South America - Colombia, Medellin
					</MenuItem>
					<MenuItem value="live-lim">
						South America - Peru, Lima
					</MenuItem>
					<MenuItem value="live-dfw">
						US Central - Dallas, TX
					</MenuItem>
					<MenuItem value="live-den">
						US Central - Denver, CO
					</MenuItem>
					<MenuItem value="dfw56.contribute.live-video.net">
						US Central - Garland, TX
					</MenuItem>
					<MenuItem value="live-hou">
						US Central - Houston, TX
					</MenuItem>
					<MenuItem value="live-slc">
						US Central - Salt Lake City, UT
					</MenuItem>

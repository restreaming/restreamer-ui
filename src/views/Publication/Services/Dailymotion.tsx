...
const description = (
  <Trans>
    ...
    <Link
      color="secondary"
      target="_blank"
      href="https://faq.dailymotion.com/hc/en-us/articles/115009103088-Create-and-configure-a-live-stream"
    >
      Here{" "}
    </Link>
...
const image_copyright = (
  <Trans>
    Please get in touch with the operator of the service and check what happens.
  </Trans>
);
const author = {
  creator: {
    ...
    <Grid container spacing={2}>
      <Grid size={12}>
        <TextField
          ...
          error={
            settings.server_url.includes("rtmp://") ||
            settings.server_url.includes("rtmps://")
              ? false
              : true
          }
          helperText={
            ...
            settings.server_url.includes("rtmps://")
              ? false
              : "Please enter a valid RTMP/S URL."
          }
        />
      </Grid>
      <Grid

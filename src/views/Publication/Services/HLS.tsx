...
const description = (
	<Trans>
		Transmit the main source as HTTP-Live-Streaming (HLS) to an HTTP/S
		Server. More details about the settings can be found{' '}
		<Link
			color="secondary"
			target="_blank"
			href="http://ffmpeg.org/ffmpeg-all.html#hls"
		>
			here
		</Link>
		.
						...
						<Grid container spacing={2}>
							...
							<Grid size={12}>
								<Checkbox
									...
									onChange={handleChange('hls_allow_cache')}
								/>
								<Checkbox
							...
							<Grid
								...
								<TextField
									...
									value={
										settings.options.hls_delete_threshold
									}
							...
							<Grid size={12}>
								<TextField
									...
									value={
										settings.options.hls_segment_filename
									}
									onChange={handleChange(
										'hls_segment_filename',
									)}
							...
							<Grid
								...
								<Select
									...
									value={
										settings.options.hls_start_number_source
									}
									onChange={handleChange(
							...
							<Grid size={12}>
								<Typography>
									...
									<Link
										color="secondary"
										target="_blank"
										href="https://ffmpeg.org/ffmpeg-all.html#hls"
									>

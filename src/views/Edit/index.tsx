		...
		const save = async () => {
			...
			if (err !== null) {
				notify.Dispatch(
					...
					'save:ingest',
					i18n._(
						t`Failed to update ingest snapshot process (${err.message})`,
					),
				);
			}
	...
	const handleChannelDelete = async () => {
		...
		if (res === false) {
			...
			notify.Dispatch(
				...
				'delete:ingest',
				i18n._(
					t`The channel "${$data.meta.name}" could not be deleted`,
				),
			);
			return;
		}
	...
	return (
		<Root>
								...
								<Grid size={12}>
									<Typography variant="body1">
										<Trans>
											...
											the live stream. Add a description,
											and set your desired content
											license.
										</Trans>
									</Typography>
								</Grid>
								...
								<Grid size={12}>
									<Typography>
										<Trans>
											...
											will see during the live stream.
										</Trans>
									</Typography>
								</Grid>
								<Grid size={12}>
								...
								<Grid size={12}>
									<Typography>
										<Trans>
											...
											right image licence. Whether free
											for all or highly restricted.
											Briefly discuss what others are
			...
			<Dialog
				...
				title={
					<Trans>
						Do you want to disconnect "{$data.meta.name}"?
					</Trans>
				}
				buttonsLeft={
					<Button
			...
			>
				<Typography>
					<Trans>
						This source cannot be edited while it is in use. To
						continue, you have to disconnect the source.
					</Trans>
				</Typography>
			</Dialog>
			<Dialog
				...
				title={
					<Trans>Do you want to delete "{$data.meta.name}"?</Trans>
				}
				buttonsLeft={
					<Button
						variant="outlined"
			...
			>
				<Typography>
					<Trans>
						The deletion of this channel can not be recovered. All
						publications of this channel will be removed.
					</Trans>
				</Typography>
			</Dialog>

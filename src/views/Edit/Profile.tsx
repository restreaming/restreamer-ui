...
export default function Profile(props) {
  ...
  const handleProbeStreams = (type, device, settings, inputs, res) => {
    ...
    if (type === "video") {
      ...
      const profile = M.preselectProfile(
        "video",
        res.streams,
        $profile,
  ...
  return (
    <React.Fragment>
                      ...
                      <Typography>
                        <Trans>
                          ...
                          <Link
                            color="textSecondary"
                            href="#!"
                            onClick={handleProbeLogModal("video")}
                          >
                            probe details
                          </Link>
                          .
                  ...
                  <React.Fragment>
                    <Grid size={12}>
                      <StreamSelect
                        ...
                        onChange={handleStreamSelect("video", "stream")}
                      />
                    </Grid>
            ...
            buttonsLeft={
              <React.Fragment>
                ...
                <Button
                  variant="outlined"
                  color="primary"
                  disabled={$videoProbe.status !== "success"}
                        ...
                        <BoxText color="dark">
                          ...
                          <Typography>
                            <Trans>
                              ...
                              <Link
                                href="#!"
                                onClick={handleProbeLogModal("audio")}
                              >
                                probe details
                              </Link>
                              .
                      ...
                      <React.Fragment>
                        <Grid size={12}>
                          <StreamSelect
                            ...
                            onChange={handleStreamSelect("audio", "stream")}
                          />
                        </Grid>
                        <Grid sx={{ textAlign: "right" }} size={12}>
                          <Typography>
      ...
      <Backdrop
        open={$videoProbe.probing || $audioProbe.probing || $skillsRefresh}
      >

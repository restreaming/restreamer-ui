      ...
      <Grid container spacing={2}>
          ...
          <React.Fragment>
            {props.encodersList.length === 0 ? (
              <Grid size={12}>
                <Typography>
                  <Trans>
                    Your stream needs to be encoded, but there's no suitable
                    encoder available.
                  </Trans>
                </Typography>
              </Grid>
              ...
              <React.Fragment>
                <Grid size={12}>
                  <Typography>
                    <Trans>
                      Your stream needs to be encoded. Choose the desired
                      encoder:
                    </Trans>
                  </Typography>
                </Grid>
        ...
        <Grid size={9}>
          <Button
            ...
            color="primary"
            disabled={
              props.compatible === false && props.encodersList.length === 0
            }

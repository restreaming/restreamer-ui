		...
		<Grid container spacing={2} sx={{ mt: 0.5, alignItems: 'flex-start' }}>
			...
			<Grid size={12}>
				...
				>
					...
					<MenuItem value="testsrc">
						{i18n._(t`Test pattern`)}
					</MenuItem>
					<MenuItem value="testsrc2">
						{i18n._(t`Test pattern (extended)`)}
					</MenuItem>
					<MenuItem value="rgbtestsrc">
						{i18n._(t`RGB test pattern`)}
					</MenuItem>
					<MenuItem value="yuvtestsrc">
						{i18n._(t`YUV test pattern`)}
					</MenuItem>

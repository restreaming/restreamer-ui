  ...
  return (
    <Root>
                  ...
                  {$updates.has === true && (
                    <BoxText color="success">
                      ...
                      >
                        ...
                        >
                          <Trans>
                            There are updates available. Here you get more
                            information.
                          </Trans>
                        </Link>
                      </Typography>
                ...
                <Grid size={12}>
                  ...
                  {$config.outdated === true && (
                    <Typography variant="caption">
                      <Trans>
                        The application is using an older version of the
                        settings.
                      </Trans>
                    </Typography>
                  )}
            ...
            <TabPanel value={$tab} index="network" className="panel">
              <Grid container spacing={2}>
                ...
                <Grid size={12}>
                  ...
                  <Typography variant="caption">
                    <Trans>
                      The public reachable domain name of the host this
                      Restreamer is running on. Separate multiple domain names
                      by a comma.
                    </Trans>
                  </Typography>
                </Grid>
                ...
                <Grid size={12}>
                  ...
                  <Typography variant="caption">
                    <Trans>
                      Let's Encrypt requires one or more public domain names and
                      an accessible port 80/TCP.
                    </Trans>
                  </Typography>
                </Grid>
                <Grid size={12}>
                  ...
                  <Typography variant="caption">
                    <Trans>
                      Please enter your email address to signify agreement with
                      the Let's Encrypt CA's terms of service and to be notified
                      in case of issues.
                    </Trans>
                  </Typography>
                </Grid>
                ...
                >
                  ...
                  <Typography variant="caption">
                    <Trans>
                      Sets a viewer limit for HLS sessions. If the limit is
                      exceeded, HLS viewers receive the HTTP status code 509
                ...
                >
                  ...
                  <Typography variant="caption">
                    <Trans>
                      Sets a bandwidth limit in Mbit per second for outgoing HLS
                      data transfer. All services, such as RTMP and outgoing
                      processes, are included in the calculation. If the
                      bandwidth is exceeded, HLS viewers receive the HTTP status
                      code 509 (Bandwidth Limit Exceeded). 0 is unlimited.
                    </Trans>
                  </Typography>
                </Grid>
              </Grid>
            ...
            <TabPanel value={$tab} index="auth" className="panel">
              <Grid container spacing={2}>
                ...
                <Grid size={12}>
                  ...
                  <Typography variant="caption">
                    <Trans>
                      Enabling authorization is strongly advised. Otherwise,
                      anybody can access this instance.
                    </Trans>
                  </Typography>
                </Grid>
                <Grid size={12}>
                  <TextField
                    ...
                    disabled={
                      env("api.auth.username") || !config.api.auth.enable
                    }
                ...
                <Grid size={12}>
                  <Password
                    ...
                    disabled={
                      env("api.auth.password") || !config.api.auth.enable
                    }
            ...
            <TabPanel value={$tab} index="playback" className="panel">
              <Grid container spacing={2}>
                ...
                <Grid size={12}>
                  <Checkbox
                    label={
                      <Trans>HLS statistic for the In-memory storage</Trans>
                    }
                ...
                <Grid size={12}>
                  <TextField
                    ...
                    disabled={
                      env("sessions.ip_ignorelist") || !config.sessions.enable
                    }
                  ...
                  <Typography variant="caption">
                    <Trans>
                      List of IP ranges in CIDR notation, e.g., 127.0.0.1/32,
                      that the statistics will not record—one IP range per line.
                ...
                <Grid size={12}>
                  <TextField
                    ...
                    disabled={
                      env("sessions.session_timeout_sec") ||
                  ...
                  <Typography variant="caption">
                    <Trans>
                      Time until an inactive viewer connection is treated as
                      closed.
                    </Trans>
                  </Typography>
                </Grid>
                <Grid size={12}>
                  <Checkbox
                    ...
                    disabled={
                      env("sessions.persist") || !config.sessions.enable
                    }
            ...
            <TabPanel value={$tab} index="storage" className="panel">
              <Grid container spacing={2}>
                ...
                <Grid size={12}>
                  ...
                  <Typography variant="caption">
                    <Trans>
                      Enabling basic auth is strongly advised. Otherwise,
                      anybody could write data to /memfs.
                    </Trans>
                  </Typography>
                </Grid>
                <Grid
                ...
                >
                  <TextField
                    ...
                    disabled={
                      env("storage.memory.auth.username") ||
                ...
                >
                  <Password
                    ...
                    disabled={
                      env("storage.memory.auth.password") ||
                      !config.storage.memory.auth.enable
                    }
                ...
                <Grid size={12}>
                  ...
                  <Typography variant="caption">
                    <Trans>
                      Maximum allowed megabytes of RAM for /memfs, 0 for
                      unlimited.
                    </Trans>
                  </Typography>
                </Grid>
                <Grid size={12}>
                  <Checkbox
                    ...
                    disabled={
                      ...
                      toInt(config.storage.memory.max_size_mbytes) <= 0
                    }
                ...
                <Grid size={12}>
                  ...
                  <Typography variant="caption">
                    <Trans>
                      Maximum allowed megabytes to consume from hard disk. 0 for
                      unlimited.
                    </Trans>
                  </Typography>
                </Grid>
                ...
                <Grid size={12}>
                  <TextField
                    ...
                    disabled={
                      env("storage.disk.cache.max_size_mbytes") ||
                    ...
                    error={
                      parseInt(config.storage.disk.cache.max_file_size_mbytes) >
                        parseInt(config.storage.disk.cache.max_size_mbytes) &&
                ...
                >
                  <TextField
                    ...
                    disabled={
                      env("storage.disk.cache.ttl_seconds") ||
                      !config.storage.disk.cache.enable
                    }
                ...
                >
                  <TextField
                    ...
                    disabled={
                      env("storage.disk.cache.max_file_size_mbytes") ||
                      !config.storage.disk.cache.enable
                    }
                ...
                <Grid size={6}>
                  <TextField
                    ...
                    disabled={
                      env("storage.disk.cache.types.allow") ||
                      !config.storage.disk.cache.enable
                    }
                  ...
                  <Typography variant="caption">
                    <Trans>
                      List of file extensions to cache (e.g. ".html"), one per
                      line. Leave empty to cache all file types.
                    </Trans>
                  </Typography>
                </Grid>
                <Grid size={6}>
                  <TextField
                    ...
                    disabled={
                      env("storage.disk.cache.types.block") ||
                      !config.storage.disk.cache.enable
                    }
                  ...
                  <Typography variant="caption">
                    <Trans>
                      List of file extensions not to cache (e.g. ".m3u8"), one
              ...
              <Grid container spacing={2}>
                ...
                >
                  <TextField
                    ...
                    disabled={
                      env("rtmp.address") ||
                      (!config.rtmp.enable && !config.rtmp.enable_tls)
                    }
                ...
                <Grid size={12}>
                  ...
                  <Typography variant="caption">
                    <Trans>
                      RTMP token for publishing and playing. The token is the
                      value of the URL query parameter 'token.'
                    </Trans>
                  </Typography>
                </Grid>
              </Grid>
            ...
            <TabPanel value={$tab} index="srt" className="panel">
              <Grid container spacing={2}>
                ...
                >
                  ...
                  <Typography variant="caption">
                    <Trans>
                      SRT token for publishing and playing. The token is the
                      value of the streamid parameter 'token.'
                    </Trans>
                  </Typography>
                </Grid>
                <Grid size={12}>
          ...
          <PaperContent>
            {$restart.timeout === false ? (
              ...
              <React.Fragment>
                <Typography variant="body1">
                  <Trans>
                    Reconnecting to Restreamer Core failed for the last{" "}
                    {RETRIES} seconds.
                  </Trans>
                </Typography>
                <Typography variant="body1" sx={{ mt: "1em" }}>
                  <Trans>
                    If you enabled Let's Encrypt TLS it might take some time to
                    acquire the certificates. Make sure that Restreamer Core is
                    reachable via port 80 from the internet. Please check the
                    console log of Restreamer Core.
                  </Trans>
                </Typography>
                <Typography variant="body1" sx={{ mt: "1em" }}>
                  <Trans>
                    If you changed the ports, it might be that Restreamer Core
                    restarted already, but it is now available on a different
                    port.
                  </Trans>
                </Typography>
              </React.Fragment>
      ...
      >
        <Typography variant="body1">
          <Trans>
            You have changed the configuration. In order for the changes to take
            effect, you have to restart the application. Do you want to restart
            now?
          </Trans>
        </Typography>
      </Dialog>

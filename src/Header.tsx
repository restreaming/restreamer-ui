        ...
        <StyledGrid container spacing={1}>
          ...
          <Grid size={12}>
            <Typography variant="body1">
              This is the frontend and a part of a free open source
              livestreaming solution for video data. The second part is the{" "}
              <Link
                color="secondary"
                href="https://github.com/datarhei/core"
                target="_blank"
              >
                datarhei Core
              </Link>{" "}
          ...
          <Grid size={12}>
            ...
            <Typography>
              ...
              <Link
                color="secondary"
                target="_blank"
                href="https://github.com/datarhei/restreamer"
              >
            ...
            <Typography>
              ...
              <Link
                color="secondary"
                target="_blank"
                href="https://github.com/datarhei/restreamer/blob/master/LICENSE"
              >
                Apache License 2.0
              </Link>
            </Typography>
            <Typography>
              ...
              <Link
                color="secondary"
                target="_blank"
                href="https://patreon.com/datarhei/"
              >
  ...
  if (props.expand === true) {
    return (
      <React.Fragment>
        ...
        <Fab
          className={props.hasUpdates ? "headerFabHighlight" : "headerFab"}
          color="primary"
          ...
          {props.showSettings === true && (
            <MenuItem onClick={props.onSettings}>
              <ListItemIcon>
                <Settings
                  fontSize="small"
                  className={props.hasUpdates ? classes.colorHighlight : ""}
                />
              </ListItemIcon>
              <Trans>System</Trans>
            </MenuItem>

(function () {
...
})()(
	{
			...
			function (require, module, exports) {
				...
				window.CustomElements.addModule(function (scope) {
					...
					function register(name, options) {
						...
						if (name.indexOf('-') < 0) {
							throw new Error(
								"document.registerElement: first argument ('name') must contain a dash ('-'). Argument provided was '" + String(name) + "'.",
							);
						}
		...
		2: [
			function (require, module, exports) {
				...
				function _defineProperty(e, r, t) {
					return (
						(r = _toPropertyKey(r)) in e ? Object.defineProperty(e, r, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : (e[r] = t),
						e
					);
				}
		...
		4: [
			...
			{ './chromecast/ChromecastSessionManager': 2 },
		],
		5: [
			function (require, module, exports) {
				'use strict';
			...
			{ './components/ChromecastButton': 3, './enableChromecast': 4, './preloadWebComponents': 6, './tech/ChromecastTech': 8 },
		],
		6: [
			function (require, module, exports) {
				'use strict';
			...
			{ 'webcomponents.js/webcomponents-lite.js': 1 },
		],
		7: [
			function (require, module, exports) {
				'use strict';
		...
		8: [
					...
					class ChromecastTech extends Tech {
						...
						_playSource(source, startTime) {
							...
							mediaInfo.streamType =
								this.videojsPlayer.liveTracker && this.videojsPlayer.liveTracker.isLive()
			...
			{ '../chromecast/ChromecastSessionManager': 2, './ChromecastTechUI': 9 },
		],
		9: [
			function (require, module, exports) {
				'use strict';
